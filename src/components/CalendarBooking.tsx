      ...
      <div className="bg-white border-2 border-navy w-full max-w-[550px] shadow-2xl relative flex flex-col max-h-[90vh]">
        ...
        <div className="bg-navy text-white px-6 py-4 flex justify-between items-center select-none">
          <div className="flex items-center gap-2">
            ...
            <h3 className="font-extrabold text-lg uppercase tracking-wider">Book a 30‑Min Architecture Call</h3>
          </div>
          <button 
            onClick={onClose} 
        ...
        <div className="p-6 overflow-y-auto flex-1">
          {success ? (
            <div className="flex flex-col items-center text-center py-8 gap-4">
              ...
              <h4 className="text-xl font-extrabold text-navy uppercase tracking-tight">Appointment Secured</h4>
              <p className="text-sm text-text-secondary max-w-sm">
                Thank you! Your 30-minute retail architecture consultation is booked. A calendar invite and conference link have been sent to your email.
              </p>
              <button 
                onClick={() => { setSuccess(false); onClose(); }} 
                className="mt-4 px-6 py-2.5 bg-navy text-white font-bold hover:bg-navy/90 text-sm shadow-md"
              >
                Close Window
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4 text-left">
              ...
              <div className="border-t border-gray-150 pt-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    <label className="text-xs font-bold text-text-primary uppercase block mb-1">Jewellery Store / Company Name</label>
                    <input 
                      type="text"
                      value={company}
              ...
              <div className="border-t border-gray-150 pt-4">
                ...
                <textarea 
                  ...
                  className="w-full border border-gray-300 p-2.5 text-sm font-semibold rounded-none focus:outline-none focus:border-navy resize-none"
                />
              </div>

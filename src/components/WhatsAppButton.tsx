...
export function WhatsAppButton() {
  const phoneNumber = '919160863406'; // WhatsApp format: CountryCode + Number (no +, no spaces)
  const message = "Hi Abraham, I just saw your profile and would like to discuss more about your consulting on retail systems";
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
      ...
      <div className="relative w-14 h-14 flex items-center justify-center">
        ...
        <motion.a
          ...
          whileTap={{ scale: 0.92 }}
          className="w-full h-full rounded-full bg-[#25D366] hover:bg-[#20ba59] text-white flex items-center justify-center shadow-2xl transition-colors cursor-pointer"

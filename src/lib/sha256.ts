 ...
 * Works reliably in all browsers, legacy environments, secure and non-secure contexts, and webviews.
 */
export function sha256(ascii: string): string {
  ...
  let i, j; // Used as temporary indices
  ...
  const wordsLength = ((hashBitLength + 64) >>> 9 << 4) + 16;

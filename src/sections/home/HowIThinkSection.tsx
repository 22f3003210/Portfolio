        ...
        <ScrollReveal className="w-full">
          <div className="bg-gradient-to-br from-[#0B1E2E] to-[#05101A] rounded-none border border-white/10 p-8 md:p-12 text-white shadow-xl relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none overflow-hidden select-none">
              {/* Radial galaxy glows */}
              <div className="absolute -top-20 -left-20 w-[400px] h-[400px] bg-[#0170B9]/10 rounded-full blur-[100px]" />
              <div className="absolute bottom-0 right-0 w-[450px] h-[400px] bg-indigo-500/10 rounded-full blur-[100px]" />
              <div className="absolute top-1/3 left-1/4 w-[350px] h-[350px] bg-purple-500/5 rounded-full blur-[90px]" />
              <div className="absolute bottom-1/4 right-1/3 w-[300px] h-[300px] bg-teal-500/10 rounded-full blur-[90px]" />
              
              {/* Stars SVG overlay */}
              <svg className="absolute inset-0 w-full h-full opacity-60" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <path id="sparkle" d="M0,-4 Q0,0 -4,0 Q0,0 0,4 Q0,0 4,0 Q0,0 0,-4" fill="#ffffff" />
                </defs>
                <g fill="#ffffff">
                  {/* Tiny Stars */}
